...
app.get("/posts/:postEntry", function(req,res){
  console.log("FULL URL: /posts/" + req.params.postEntry);  // req.params.paramName
  const requestedPost = _.lowerCase(req.params.postEntry);
